...
VulkanPipeline::VulkanPipeline(const VulkanDevice& device, VkRenderPass renderPass, VkExtent2D extent)
    : m_device(device)
{
...
void VulkanPipeline::createPipeline(VkRenderPass renderPass, VkExtent2D extent) {
